...
namespace Spatie\LaravelDashboard\Console\Components\Packagist;

use GuzzleHttp\Client;
use Illuminate\Console\Command;
use Spatie\Packagist\Packagist;
use Spatie\LaravelDashboard\Events\Packagist\TotalsFetched;
...
class FetchTotals extends Command
{
    ...
    public function handle()
    {
        ...
        $totals = collect($packagist->getPackagesByVendor(config('dashboard.services.packagist.vendor'))['packageNames'])
